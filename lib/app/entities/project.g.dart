  ...
  switch (propertyId) {
    ...
    case 1:
      return (_ProjectstatusValueEnumMap[reader.readByteOrNull(offset)] ??
          ProjectStatusEnum.inProgress) as P;
    default:
...
const _ProjectstatusValueEnumMap = {
  0: ProjectStatusEnum.inProgress,
  1: ProjectStatusEnum.finished,
};
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> statusBetween(
    ProjectStatusEnum lower,
    ProjectStatusEnum upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, ProjectStatusEnum, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
